...
<head>
  ...
  <title>Uzhma Wipala Mahasinuhu | Dashboard</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><i class="fa fa-thumb-tack"></i> Tambah Tim</a></li>
            <li><a href="<?php echo base_url().'admin/portfolio'?>"><i class="fa fa-list"></i> Daftar Tim</a></li>
          </ul>
        </li>
