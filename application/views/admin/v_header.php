...
<header class="main-header">
    ...
    <a href="" style="background-color:#E8552B;" class="logo">
      ...
      <span class="logo-mini"><img style="width:20px;" src="<?php echo base_url('assets/img/uzhma1.png')?>" alt="" class="img-fluid mb-3"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Uzhma Wipala Mahasinuhu</span>
    </a>
