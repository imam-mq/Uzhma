...
<head>
  ...
  <title>Uzhma Wipala Mahasinuhu | Log in</title>
...
<div class="login-box">
  ...
  <div style="border-radius:20px;" class="login-box-body">
    <p class="login-box-msg"> <img style="width:150px;" src="<?php echo base_url('assets/img/uzhma1.png')?>" alt="" class="img-fluid mb-3"></p><hr/>
    ...
    <!-- /.social-auth-links -->
    <hr/>
    <p><center>Copyright <?php echo '2020'?> by Uzhma Wipala Mahasinuhu <br/> All Right Reserved</center></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
