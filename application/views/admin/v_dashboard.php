...
<?php
  ...
  <div class="content-wrapper">
    ...
    <div class="alert alert-info mt-2" role="alert"> <strong>WELCOME ! Selamat datang di dashboard website Uzhma Wipala Mahasinuhu <i class="fa fa-heart"></i></strong></div>
      <!-- Info boxes -->
      <div class="row">
